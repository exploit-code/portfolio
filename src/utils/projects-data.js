...
export const projects = [
  {
    ...
    title: "Fake-Shop",
    technologies: [<ReactIcon key="ReactIcon" />, <ReduxIcon key="ReduxIcon" />, <SassIcon key="SassIcon" />],
    uuid: uuidv4(),
  },
  {
    link: "https://github-search-ruddy.vercel.app/",
    title: "GitHub Users Search",
    technologies: [<ReactIcon key="ReactIcon" />, <TSIcon key="TSIcon" />, <ReduxIcon key="ReduxIcon" />, <SassIcon key="SassIcon" />],
    uuid: uuidv4(),
  },
  {
    link: "https://drweb.africa/landing/partner_demo",
    title: "Become a partner of the Doctor Web brand",
    technologies: [<HtmlIcon key="HtmlIcon" />, <SassIcon key="SassIcon" />, <AlpineIcon key="AlpineIcon" />],
    uuid: uuidv4(),
  },
  {
    link: "https://www.drweb.cn/landing/promo_drweb",
    title: "Dr.Web Security Space",
    technologies: [<HtmlIcon key="HtmlIcon" />, <SassIcon key="SassIcon" />, <JsIcon key="JsIcon" />],
    uuid: uuidv4(),
  },
  {
  ...
  },
  {
    ...
    technologies: [<HtmlIcon key="HtmlIcon" />, <SassIcon key="SassIcon" />, <JsIcon key="JsIcon" />, <AlpineIcon key="AlpineIcon" />],
    uuid: uuidv4(),
  },
  {
